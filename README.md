...
<p>
This simpler setup allows the portfolio and blog site to be very low cost, free hosting through <a href="http://www.GatsbyJS.com">GatsbyCloud</a> means that I only have to pay for the annual domain name registration (for which I had already used [GoDaddy](http://www.GoDaddy.com)).  I can just push to GitHub for new content, new site features or improvements.  The automated CI / CD environment allows for easy deployments and content updates, and can be easily replaced with a scalable backend solution if the need arises and the expense becomes justifiable.
</p>
